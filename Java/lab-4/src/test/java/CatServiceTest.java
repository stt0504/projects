...
public class CatServiceTest {
    ...
    public void getAllCats() {
        ...
        CatService service = new CatService(dao, dao3);

        List<CatDTO> catDTOs = new ArrayList<>();
        catDTOs.add(new CatDTO().setName("Cat1").setBreed("Breed1").setOwner(OwnerService.convert(owner1)));
        catDTOs.add(new CatDTO().setName("Cat2").setBreed("Breed2").setOwner(OwnerService.convert(owner1)));
    ...
    public void AddCatTest_Failed_NameIsEmpty() {
        ...
        CatDTO catDTO = new CatDTO().setName("")
                .setBirthDate(LocalDate.of(2000, 1, 1))
                .setOwner(OwnerService.convert(owner1));
        assertThrows(IllegalArgumentException.class, () -> service.addCat(catDTO));
