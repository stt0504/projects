...
public class Producer {
    @Bean
    public ProducerFactory<String, List<CatDTO>> producerFactoryList() {
    ...
    @Bean
    public KafkaTemplate<String, List<CatDTO>> kafkaTemplateList() {
        return new KafkaTemplate<>(producerFactoryList());
    }
